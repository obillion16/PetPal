...
(function() {
    ...
    function submitDonation() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    // Show appropriate success modal based on payment method
                    if (formData.payment_method === 'credit_card') {
                        showSuccessCreditCard(response.message);
                    } else {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    // Use credit card success modal for card submissions
                    showSuccessCreditCard(message);
                    resetForm();
                } else {
     ...
     */
    function showSuccessCreditCard(message) {
        $('#successMessageCreditCard').text(message);
        $('#successModalCreditCard').modal('show');
    }
